      ...
      <div style={{ display: 'flex', justifyContent: 'center', paddingTop: 40 }}>
        ...
        >
          <div style={{ background: '#075e54', padding: '20px 24px', display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <div style={{ color: '#fff', fontSize: 28, fontWeight: 600 }}>TechStore Support</div>
              <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: 22 }}>online</div>
            </div>
          </div>
          ...
          <WaInputBar placeholder="Type a message" />
        </div>
      </div>
