  ...
  return (
    <section id="contact" className="relative py-32 px-6 bg-surface overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <CalendlyButton
          className="inline-block bg-black text-white px-8 py-3 text-lg rounded-full font-medium transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.2)] focus-ring"
